...
from vanitynumber.library import helper
from vanitynumber.library import t9_graph_node
...
def all_wordifications(phone_number: str, max_number_results_to_output=5) -> List[str]:
    """
    Args:
